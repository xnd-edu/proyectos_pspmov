package problema1.conSynchronized;
...
public class HilosVirtualesSync {
    private static final Logger logger = LoggerFactory.getLogger(HilosVirtualesSync.class);
    ...
    public HilosVirtualesSync(ContadorVisitas contadorVisitas) {
    ...
    public void ejecutarPrueba() {
        ...
        for (int i = 0; i < visitasEsperadas; i++) {
            ...
            Thread hiloVirtual = Thread.ofVirtual().start(() -> {
                ...
                contadorVisitas.incrementarVisitaSynchronized();
            });
