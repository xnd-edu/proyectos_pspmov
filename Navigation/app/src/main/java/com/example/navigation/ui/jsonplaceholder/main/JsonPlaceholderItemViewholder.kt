...
import com.example.navigation.databinding.ItemPostBinding
import com.example.navigation.domain.model.JsonPlaceholderPost
import com.google.android.material.card.MaterialCardView
import com.google.android.material.listitem.ListItemLayout
import com.google.android.material.shape.ShapeAppearanceModel

class JsonPlaceholderItemViewholder(
    itemView: View,
    val actions: JsonPlaceholderAdapter.PostActions
    ...
    fun bind(item: JsonPlaceholderPost, position: Int, itemCount: Int) {
        with(binding) {
            postTitulo.text = item.title
            postCuerpo.text = item.body
